 ...
 * proprietario Hertz: superficie Signal, frequency grid, data/città e il
 * simbolo Hertz (stessa geometria di WaveformPulse, statico). Nessuna
 * diagonale/hatch da wireframe tecnico. Un solo componente riusato da
 * FeaturedEvent, EventModule ed EventPosterPortal.
 */
