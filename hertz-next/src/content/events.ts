...
export const EVENTS: HertzEvent[] = [
  ...
  { n: '029', title: 'Hertz at Barracuda Club', venue: 'Barracuda', city: 'Lido di Spina', iso: '2026-07-25',
    time: 'SAT · 23:30 → LATE', badge: 'Collaboration', poster: '/assets/poster-v3-25lug-barracuda.jpg',
    bill: 'Federico Apadula · Leonardo Giusti · Gemi', lineup: ['federico-apadula', 'leonardo-giusti'] },
  { n: '030', title: 'Hertz at Buongiorno Classic', venue: 'Buongiorno Classic', city: 'Rimini', iso: '2026-07-26',
    ...
    bill: 'Antonio Pica · Da Vid · Jay De Lys · Joey Daniel · Federico Apadula · Tommaso Mancò · Alberto B',
